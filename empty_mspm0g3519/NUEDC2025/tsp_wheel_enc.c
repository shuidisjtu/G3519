...
static volatile int16_t  g_speed[2];
static volatile uint16_t g_last_raw[2];
static volatile uint32_t g_last_tick;
static volatile uint8_t  g_first_run;
...
static void wheel_enc_reset_state(void)
{
