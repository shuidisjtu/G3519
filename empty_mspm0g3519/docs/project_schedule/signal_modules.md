...
| TJC 串口屏 (4.3 寸) | **已验证** | UART3 (J4, PC6/PC7) 115200-8N1 双向通信验证通过（按钮事件/页面跳转/数值更新/文本更新/addt 波形透传）。J4 5V 带载不足，屏需独立供电。详见 [TJC_UI_Spec.md]、[TJC4827X543_011C_Use.md] |
...
[TJC_UI_Spec.md]: ../development_reference/TJC_UI_Spec.md
