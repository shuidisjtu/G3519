...
// DDS AD9833 bit-bang control (PC2=SCLK, PC3=SDATA, PC24=FSYNC)
#define DDS_FSYNC_LOW()   DL_GPIO_clearPins(PORTC_PORT, PORTC_DDS_FSYNC_PIN)
#define DDS_FSYNC_HIGH()  DL_GPIO_setPins(PORTC_PORT, PORTC_DDS_FSYNC_PIN)
#define DDS_SCLK_LOW()    DL_GPIO_clearPins(PORTC_PORT, PORTC_DDS_SCLK_PIN)
#define DDS_SCLK_HIGH()   DL_GPIO_setPins(PORTC_PORT, PORTC_DDS_SCLK_PIN)
